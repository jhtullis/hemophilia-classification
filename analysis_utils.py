...
MODEL_REGISTRY: Dict[str, Tuple[str, int, dict]] = {
    ...
    "mpatch_v1e_lite_lc05b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc05b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc10b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc10b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc15b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc15b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc20b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc20b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc25b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc25b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc30b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc30b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc35b":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc35b"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc05c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc05c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc10c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc10c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc15c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc15c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc20c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc20c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc25c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc25c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc30c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc30c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc35c":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc35c"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc05d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc05d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc10d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc10d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc15d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc15d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc20d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc20d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc25d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc25d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc30d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc30d"),     5, CLASS_MAP),
    "mpatch_v1e_lite_lc35d":     (os.path.join(_DIR, "models", "mpatch_v1e_lite_lc35d"),     5, CLASS_MAP),
}

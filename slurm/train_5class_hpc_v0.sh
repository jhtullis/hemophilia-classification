...
trap 'echo "Wall time approaching — resubmitting..."; sbatch "${PROJECT_DIR}/slurm/train_5class_hpc_v0.sh"; exit 0' USR1

module load miniforge3
conda activate fibrin

export WANDB_MODE=offline
export WANDB_DIR="${PROJECT_DIR}/models/5class_hpc_v0"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    sbatch "${PROJECT_DIR}/slurm/train_5class_hpc_v0.sh"
fi
